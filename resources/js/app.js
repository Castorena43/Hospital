...
Vue.component('especialidad-component', require('./components/EspecialidadComponent.vue').default);
Vue.component('paciente-component', require('./components/PacienteComponent.vue').default);
Vue.component('consultorio-component', require('./components/ConsultorioComponent.vue').default);
